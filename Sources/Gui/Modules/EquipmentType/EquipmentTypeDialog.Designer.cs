...
{
	partial class EquipmentTypeDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.okButton.Location = new System.Drawing.Point(80, 40);
			...
			this.cancelButton.Location = new System.Drawing.Point(161, 40);
			...
			// bindingSource
			// 
			this.bindingSource.DataSource = typeof(Shared.InfoObjects.EquipmentTypeInfo);
			// 
			// errorProvider
			// 
